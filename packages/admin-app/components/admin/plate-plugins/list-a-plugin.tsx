...
export const LIST_A_KEY = "list_a";

export function ListAElement(props: PlateElementProps) {
...
export const ListAPlugin = createPlatePlugin({
  key: LIST_A_KEY,
  node: { isElement: true, isVoid: true, type: LIST_A_KEY },
  render: { node: ListAElement },
});
