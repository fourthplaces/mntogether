...
/** Walk React children tree to build value→label record for Base UI's native items prop */
  ...
  function walk(node: React.ReactNode) {
    React.Children.forEach(node, (child) => {
      ...
      if (child.type === SelectItem && props.value != null) {
        record[String(props.value)] = props.children as React.ReactNode
      }
...
function Select<Value, Multiple extends boolean | undefined = false>(
  ...
  const items = React.useMemo(
    () => props.items ?? collectItems(props.children),
