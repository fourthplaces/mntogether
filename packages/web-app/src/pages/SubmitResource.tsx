...
import { SUBMIT_RESOURCE_LINK } from '../graphql/mutations';
...
export function SubmitResource() {
  ...
  const [submitResourceLink, { data, loading, error }] = useMutation(SUBMIT_RESOURCE_LINK);
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-green-700">
                  {data.submitResourceLink.message}
                </p>
                <p className="mt-2 text-xs text-green-600">
                  Job ID: {data.submitResourceLink.jobId}
                </p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-gray-500">
                Paste a link to an organization's website, social media post, or any resource that needs attention
              </p>
              {url && !isValidUrl(url) && (
