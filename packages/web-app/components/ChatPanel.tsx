      ...
      <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3 min-h-0">
        ...
        {isWaitingForReply && (
          <div className="flex justify-start">
            <div className="max-w-[80%] px-3 py-2 bg-surface-muted text-text-primary text-sm">
      ...
      >
        <div className="flex items-center gap-2">
          <input
            ...
            className="flex-1 px-4 py-2.5 bg-surface-muted border border-border text-sm text-text-primary placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-focus-ring focus:border-transparent disabled:opacity-50"
          />
          <button
            type="submit"
