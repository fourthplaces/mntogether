...
import type { ExtractionResult } from "@/lib/restate/types";
...
export default function ExtractionPage() {
  ...
  const handleIngest = async (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      try {
        const data = await callService<ExtractionResult>("Extraction", "ingest_site", {
          site_url: siteUrl,
          max_pages: maxPages,
        });
        setResult(data);
  ...
  const handleExtract = async (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      try {
        const data = await callService<ExtractionResult>("Extraction", "trigger", {
          query,
