  ...
  return (
    <div className="relative leading-relaxed">
      ...
      <section className="px-6 md:px-12 pt-16 pb-8 max-w-[1200px] mx-auto relative z-10">
        <h1 className="text-4xl sm:text-[3.5rem] font-bold text-text-primary leading-tight max-w-[800px]">
      ...
      <section className="max-w-[1200px] mx-auto px-6 md:px-12 pt-4 pb-16 grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
        <Link href="/posts?post_type=offering" className="bg-pathway-warm border-2 border-pathway-warm-border rounded-2xl p-8 flex flex-col cursor-pointer hover:bg-pathway-warm-hover hover:border-pathway-warm-hover-border transition-all duration-300">
          ...
          <span className="bg-action text-text-on-action px-7 py-3 rounded-full text-[0.95rem] font-semibold self-center mt-auto">
            Find Opportunities
          </span>
        </Link>

        <Link href="/posts?post_type=seeking" className="bg-pathway-sage border-2 border-pathway-sage-border rounded-2xl p-8 flex flex-col cursor-pointer hover:bg-pathway-sage-hover hover:border-pathway-sage-hover-border transition-all duration-300">
          <div className="flex items-center gap-3 mb-4">
        ...
        <Link href="/posts?post_type=announcement" className="bg-pathway-lavender border-2 border-pathway-lavender-border rounded-2xl p-8 flex flex-col cursor-pointer hover:bg-pathway-lavender-hover hover:border-pathway-lavender-hover-border transition-all duration-300">
          <div className="flex items-center gap-3 mb-4">
